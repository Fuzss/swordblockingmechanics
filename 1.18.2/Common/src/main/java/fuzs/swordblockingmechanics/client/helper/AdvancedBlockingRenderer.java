...
public class AdvancedBlockingRenderer {
    ...
    public static void renderBlockingWithSword(ItemInHandRenderer itemInHandRenderer, ArmedModel model, LivingEntity entity, ItemStack stack, ItemTransforms.TransformType transform, HumanoidArm arm, PoseStack poseStack, MultiBufferSource multiBufferSource, int combinedLight) {
    ...
    private static void applyItemTransformInverse(LivingEntity entity, ItemStack stack, ItemTransforms.TransformType transform, PoseStack poseStack, boolean leftHand) {
