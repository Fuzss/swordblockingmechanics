...
import com.fuzs.puzzleslib_sbm.network.NetworkHandler;
import com.fuzs.puzzleslib_sbm.proxy.IProxy;
import com.fuzs.puzzleslib_sbm.recipe.ElementConfigCondition;
import com.fuzs.puzzleslib_sbm.registry.RegistryManager;
import com.fuzs.puzzleslib_sbm.util.PuzzlesLibUtil;
...
public class PuzzlesLib {
    ...
    public static final String MODID = "puzzleslib_sbm";
